...
@Component({
  selector: 'app-cantodecomunion',
  templateUrl: './cantodecomunion.page.html',
  styleUrls: ['./cantodecomunion.page.scss'],
})
export class CantodecomunionPage implements OnInit {
