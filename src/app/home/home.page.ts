  ...
  playlist: Track[] = [
    {
      ...
      path: './assets/canciones/gozo en mi alma.mp3',
    },
    {
      name: 'VIENE CON ALEGRIA',
      path: './assets/canciones/vieneconalegria.mp3',
    },
    {
      name: 'Juntos como Hermanos',
      path: './assets/canciones/Juntos_como hermanos.mp3',
    },
    {
      name: 'Jesus esta pasando por aqui',
      path: './assets/canciones/jesus pasa por aqui.mp3',
    },
    {
      name: 'Alto escuchame',
      path: './assets/canciones/alto escuchame.mp3',
    },
    {
      name: 'El espiritu de Dios',
      path: './assets/canciones/el espiritu  dios.mp3',
    },
  ];
  show = false;
